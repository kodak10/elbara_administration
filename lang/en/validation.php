...
return [
    ...
    | versions comme les règles de taille. N'hésitez pas à modifier ces messages ici.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez spécifier ici des messages personnalisés pour les attributs
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes sont utilisées pour remplacer l’espace réservé des attributs
    | par quelque chose de plus lisible pour l’utilisateur.
    |
    */
